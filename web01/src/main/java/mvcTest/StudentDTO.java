...
//** 추가적 분류
//=> 스프링 JPA를 사용하면 객체와 Table을 구체적으로 매핑하기 때문에 Entity 로 구분함.
...
public class StudentDTO extends JoDTO {
	// 1) private으로 멤버변수 정의
	private int sno; // 테이블에 있는 컬럼명과 동일하게 작성
	private String name;
	private int age;
	private int jno;
	private String info;
	private double point; //double 8byte / float 4byte
	...
	public void setSno(int sno) {
		this.sno = sno; // this = 객체자신 / 뒷부분 sno = 매개변수
		}
