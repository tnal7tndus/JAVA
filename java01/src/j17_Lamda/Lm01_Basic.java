...
//   이를 함수형 인터페이스(Functional Interface)라 하고 이러한 함수형 인터페이스를 구현하는 경우
//   짧은 코드로 완성할수 있도록 지원하는 것이 람다식.
...
//   이들은 다양하게 활용할수있도록 각각 추상메서드를 정의해놓고 있으므로 필요에 따라 이용.
...
//		};
		...
		Printable p3 = s -> System.out.println("** LamdaTest3. Lamda식 표현 => "+s);
		};
		p3.myTest("편리해요 ~~");
