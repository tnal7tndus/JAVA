...
//	  ProceedingJoinPoint의 부모인 JoinPoint에 구현되어있음.
...
//	 가로채서 어떤 action을 한 후에 기존 리턴 값을 되돌려 주지 않으면
...
public class MyAspect {
	...
	public Object myAround(ProceedingJoinPoint joinpoint) {
		...
		for ( Object o:args ) {
			System.out.println("** Before 핵심적관심사항의 매개변수 값 => "+o);
		}
