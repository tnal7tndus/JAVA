...
//=> 1) SpeakerA xml에서 생성후 AiTVsi에서 @Autowired
//=> 2) @ 으로 생성 후  AiTVsi에서 @Autowired
...
//=> JC로 생성, Aitvsi에서 @Autowired Test
...
//=> @, xml 생성 비교 (JC로 전달 되는지)
class SpeakerB implements Speakeri {public SpeakerB() {System.out.println("~~ SpeakerBBB Default 생성자 ~~");}
