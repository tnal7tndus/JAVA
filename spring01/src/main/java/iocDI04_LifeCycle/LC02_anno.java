...
class LifeCycleTestA {
	public LifeCycleTestA() {
		System.out.println("~~ LifeCycleTestA 생성자 ~~");}

	@PostConstruct
	public void begin() {
		System.out.println("~~ LifeCycleTestA PostConstruct ~~");}

	@PreDestroy
	public void end() {
		System.out.println("~~ LifeCycleTestA PreDestroy ~~");}
...
public class LC02_anno {
	...
	public static void main(String[] args) {
		AbstractApplicationContext sc = new GenericXmlApplicationContext("iocDI04_LifeCycle/lc01.xml");
